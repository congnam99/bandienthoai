  ...
  <table class="TableData">
    ...
    <?php
            ...
            <tr class="odd gradeX">
                ...
                <td class=""><?php echo $fm->format_currency($total)?></td>
            </tr>
            <?php 
            }
         }
    ...
    <tr>
      ...
      <td></td>
      <td></td>
      <td class="tong">VAT: 10%</td>
      <td class=""><?php echo $fm->format_currency($vat); ?></td>
    </tr>

    <tr>
      <td colspan="4" class="tong">Tổng cộng:</td>
      <td class=""><?php echo $fm->format_currency($grandTotal)." VND"; ?></td>
    </tr>
  </table>
